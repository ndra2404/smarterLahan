        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="?pages=users" class="" aria-expanded="false">
						<div class="menu-icon">
                    ...
                    <li><a href="?pages=lahan" class="" aria-expanded="false">
						<div class="menu-icon">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<span class="nav-text">Lahan</span>
						</a>
					</li>
					<?php } ?>
					<?php if($_SESSION['level']==1 || $_SESSION['level']==2) {?>
                    <li><a href="?pages=rangking" class="" aria-expanded="false">
						<div class="menu-icon">
							<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<span class="nav-text">Smarter</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="?pages=kriteria">Kriteria</a></li>
							<li><a href="?pages=subkriteria">Sub Kriteria</a></li>
                            <li><a href="?pages=perhitungan">Perhitungan</a></li>
							<li><a href="?pages=lahan_harap">Kelompok lahan</a></li>
						</ul>
					</li>
					<?php } ?>
				</ul>		
